...
import { changePassword } from '@crowdcareaid-frontend/next-actions';
...
type ChangePasswordHandlerPayload = z.infer<typeof Schema.ChangePassword>;
...
const PasswordForm = ({ email }: PasswordFormProps) => {
  ...
  const form = useForm({
    resolver: zodResolver(Schema.ChangePassword),
    defaultValues: {
      newPassword: '',
      confirmPassword: '',
    },
